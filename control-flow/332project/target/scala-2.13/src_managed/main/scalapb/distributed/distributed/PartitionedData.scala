...
final case class PartitionedData(
    ...
    def addData(__vs: _root_.scala.Predef.String *): PartitionedData = addAllData(__vs)
    def addAllData(__vs: Iterable[_root_.scala.Predef.String]): PartitionedData = copy(data = data ++ __vs)
    def withData(__v: _root_.scala.Seq[_root_.scala.Predef.String]): PartitionedData = copy(data = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 4 => _root_.scalapb.descriptors.PRepeated(data.iterator.map(_root_.scalapb.descriptors.PString(_)).toVector)
      }
    }
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[distributed.distributed.PartitionedData] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      distributed.distributed.PartitionedData(
        ...
        data = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scala.Seq[_root_.scala.Predef.String]]).getOrElse(_root_.scala.Seq.empty)
      )
